...
import { useOrdersQuery, priorityBgVar, priorityColorVar, priorityLabel, statusLabel, type OrderPriority, type OrderStatus } from '@/entities/order'
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <Card>
          <div className="flex flex-wrap items-center gap-2 border-b border-[var(--color-border)] p-4">
            ...
            {query.data && <span className="ml-auto text-xs text-[var(--color-ink-400)]">Показано {query.data.length}</span>}
          </div>
